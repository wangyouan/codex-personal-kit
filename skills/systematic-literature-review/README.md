...
| **Standard（标准级）** | 6000–10000 | 50–90 | • 学位论文 Related Work<br>• 普通期刊综述<br>• research proposal 标书立项依据<br>• 项目提案 | 10–16 页 | 标准级、常规 |
...
| research proposal 标书的"立项依据"部分 | **Standard** | 足够支撑科学问题阐述 |
